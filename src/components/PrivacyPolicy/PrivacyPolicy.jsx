...
export const PrivacyPolicy = () => {
  return (
    <main>
      ...
      <Section>
        <Article>
          <ArticleHeadLine>Datenschutzerklärung</ArticleHeadLine>
          ...
          [Webseiten-URL] werden durch den Browser automatisch Informationen an
          ...
          dabei ohne Ihr Zutun erfasst: IP-Adresse Datum und Uhrzeit der Anfrage
          ...
          Ihres Rechners Die genannten Daten werden zu folgenden Zwecken
          verarbeitet: Gewährleistung eines reibungslosen Verbindungsaufbaus
          Auswertung der Systemsicherheit und -stabilität Zu administrativen
          Zwecken Die Rechtsgrundlage für die Datenverarbeitung ist Art. 6 Abs.
          1 S. 1 lit. f DSGVO.
          <br />
          <br />
          ...
          unrichtiger Daten (Art. 16 DSGVO) Löschung Ihrer Daten (Art. 17 DSGVO)
          Einschränkung der Verarbeitung (Art. 18 DSGVO) Widerspruch gegen die
          Verarbeitung (Art. 21 DSGVO) Datenübertragbarkeit (Art. 20 DSGVO)
